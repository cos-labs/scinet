# -*- coding: utf-8 -*-
#
# crowd-scholar documentation build configuration file, created by
# sphinx-quickstart on Mon Jul  8 12:46:46 2013.
#
...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.pardir, 'crowd-scholar')))
